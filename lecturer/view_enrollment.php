...
<div class="container mx-auto p-4">
    <header class="mb-8">
        <h1 class="text-3xl font-bold text-blue-800">Enrollment for: <?php echo htmlspecialchars($course_title); ?></h1>
        <p class="text-lg text-gray-600">Total Students: <?php echo mysqli_num_rows($result); ?></p>
        <a href="dashboard.php" class="text-blue-500 hover:text-blue-700 mt-2 inline-block">← Back to Dashboard</a>
    </header>
