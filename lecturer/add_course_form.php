...
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="container mx-auto px-4 lg:px-8 py-6">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Start building your new course by entering the basic
                details below.</p>
        </div>
    </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div
                ...
                <form action="add_course.php" method="POST" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <h2
                            class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-100 dark:border-gray-700 pb-2">
                            Basic Information</h2>

                        <div>
                            <label for="title"
                                class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Course
                                Title</label>
                        ...
                        <div>
                            <label for="course_image"
                                class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Course Image
                                (Optional)</label>
                            <input type="file" id="course_image" name="course_image"
                                accept="image/png, image/jpeg, image/gif"
                                class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:border-purple-500 transition-colors">
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Recommended size: 800x600px. Max
                                size: 5MB.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 pt-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="level"
                                    class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Difficulty
                                    Level</label>
                            ...
                            <div>
                                <label for="duration"
                                    class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Duration
                                    (Hours)</label>
                    ...
                    <div class="space-y-6 pt-2">
                        ...
                        <div>
                            <label for="fee"
                                class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Course Fee
                                ($)</label>
                            <div class="relative">
                                <span
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Enter 0.00 to make this course free
                                for students.</p>
                        </div>
                    </div>
