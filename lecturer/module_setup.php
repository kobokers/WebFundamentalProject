            ...
            <div class="md:col-span-1 p-6 bg-white rounded-lg shadow-xl h-fit">
                ...
                <form action="module_setup.php?course_id=<?php echo $course_id; ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="module_title" name="module_title" required class="w-full px-4 py-2 border rounded-lg">
                    </div>
                    
                    <div class="mb-6">
                        <label for="module_order" class="block text-gray-700 font-semibold mb-2">Order/Sequence (e.g., 1, 2, 3):</label>
                        <input type="number" id="module_order" name="module_order" min="1" required class="w-full px-4 py-2 border rounded-lg">
                    </div>
                    ...
                    <ul class="space-y-3">
                        <?php while ($row = mysqli_fetch_assoc($modules_result)): ?>
                            <li class="flex justify-between items-center p-4 bg-gray-50 border rounded-lg shadow-sm">
                                ...
                                <div class="space-x-2">
                                    <a href="edit_module.php?module_id=<?php echo $row['id']; ?>" class="text-sm text-purple-600 hover:text-purple-800">
