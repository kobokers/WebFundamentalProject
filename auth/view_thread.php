...
<body>
    <div class="container mx-auto p-8 max-w-5xl">
        <header class="mb-8">
            ...
            <a href="course_discussion.php?course_id=<?php echo $thread['course_id']; ?>" class="text-purple-500 hover:text-purple-700 mt-2 inline-block">← Back to Discussions</a>
        </header>
        ...
        <section id="replies" class="mb-8">
            <h2 class="text-2xl font-semibold mb-4 border-b pb-2 flex items-center"><i class="fas fa-reply mr-2"></i> Replies (<?php echo mysqli_num_rows($replies_result); ?>)</h2>
        ...
        <section id="reply-form">
            <h2 class="text-2xl font-semibold mb-4 border-b pb-2"><i class="fas fa-feather-alt mr-2"></i> Post a Reply</h2>
            <form action="view_thread.php?thread_id=<?php echo $thread_id; ?>" method="POST" class="p-6 bg-gray-50 rounded-lg shadow-md">
                <div class="mb-6">
                    <label for="reply_content" class="block text-gray-700 font-semibold mb-2">Your Reply:</label>
                    <textarea id="reply_content" name="reply_content" rows="5" required class="w-full px-3 py-2 border rounded-lg focus:ring-purple-500 focus:border-purple-500"></textarea>
                </div>
