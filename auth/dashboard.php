        ...
        <div class="container mx-auto px-4 lg:px-8 py-12">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                ...
                <div class="flex gap-3">
                    <a href="catalog.php"
                        class="bg-white/20 hover:bg-white/30 text-white font-medium px-5 py-2.5 rounded-xl transition-all flex items-center gap-2">
                        <i class="fas fa-compass"></i>
                        <span class="hidden sm:inline">Explore Courses</span>
                    </a>
                    <a href="student_transcript.php"
                        class="bg-white/20 hover:bg-white/30 text-white font-medium px-5 py-2.5 rounded-xl transition-all flex items-center gap-2">
                        <i class="fas fa-file-alt"></i>
                        <span class="hidden sm:inline">My Transcript</span>
                    </a>
                    <a href="profile_edit.php"
                        class="bg-white text-brand-blue hover:bg-blue-50 font-semibold px-5 py-2.5 rounded-xl transition-all flex items-center gap-2 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-16 mb-10">
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $total_courses; ?>
                        </div>
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    <div
                        class="w-14 h-14 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center">
                        <i class="fas fa-spinner text-2xl text-amber-500"></i>
                    </div>
                    <div>
                        <div class="text-3xl font-bold text-gray-900 dark:text-white">
                            <?php echo $in_progress_courses; ?>
                        </div>
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $completed_courses; ?>
                        </div>
        ...
        <section class="mb-10">
            ...
            <?php if (count($courses_data) > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php foreach ($courses_data as $row): ?>
                        ...
                        <!-- course card -->
                        <div
                            class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
                            <!-- Course Thumbnail Area -->
                            <div
                                class="h-36 bg-gradient-to-br from-brand-blue-light to-blue-100 dark:from-gray-700 dark:to-gray-600 relative flex items-center justify-center overflow-hidden">
                                ...
                                <?php if (!empty($row['category'])): ?>
                                    <span
                                        class="absolute top-3 left-3 bg-white/90 dark:bg-gray-800/90 text-gray-700 dark:text-gray-300 text-xs font-medium px-3 py-1 rounded-full shadow-sm z-10">
                                ...
                                <?php if ($is_complete): ?>
                                    <div
                                        class="absolute top-3 right-3 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1 shadow-sm z-10">
                            ...
                            <div class="p-5 flex-1 flex flex-col">
                                ...
                                <div class="mb-4 mt-auto">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <span
                                            class="text-sm font-bold <?php echo $is_complete ? 'text-green-600' : 'text-brand-blue'; ?>">
                                            <?php echo $progress; ?>%
                                        </span>
                                    </div>
                            ...
                            <div class="p-5 pt-0 space-y-2">
                                ...
                                <?php else: ?>
                                    ...
                                    <form method="POST"
                                        ...
                                        <button type="submit" name="cancel_enrollment"
                                            class="w-full text-red-500 hover:text-red-700 text-sm font-medium py-2 hover:underline transition-all">
                                            Cancel Enrollment
                                        </button>
                                    </form>
                                <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <div
                    ...
                    <a href="catalog.php"
                        class="inline-flex items-center gap-2 bg-brand-blue hover:bg-brand-blue-dark text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-lg">
