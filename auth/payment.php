...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['pay_submit'])) {
        ...
        if (mysqli_query($conn, $update_query)) {
            ...
            echo "<script>window.location.href = 'receipt.php?course_id={$course_id}';</script>";
            exit;
        } else {
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-700 dark:text-green-400">All transactions are secure and
                                encrypted.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                class="border-2 border-brand-blue bg-blue-50 dark:bg-blue-900/30 dark:border-blue-500 rounded-xl p-4 relative cursor-pointer">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Card
                                        Number</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Expiration</label>
                ...
                <div class="md:col-span-1">
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky top-24">
                        ...
                        <div class="flex gap-4 mb-6">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white line-clamp-2">
                                    <?php echo $course_title; ?></h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Instr.
                                    <?php echo htmlspecialchars($course_data['lecturer']); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 my-4 pt-4 space-y-2">
                            ...
                            <div
                                class="border-t border-gray-200 dark:border-gray-600 pt-2 flex justify-between items-center">
                                <span class="font-bold text-gray-900 dark:text-white text-lg">Total</span>
                                <span
                                    class="font-bold text-gray-900 dark:text-white text-2xl">$<?php echo number_format($course_fee, 2); ?></span>
                            </div>
                        </div>
