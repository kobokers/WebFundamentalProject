                    ...
                    <tbody class="text-gray-600 dark:text-gray-400 text-sm font-light">
                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <td class="py-3 px-6 text-left">
                                <span
                                    class="font-semibold text-<?php echo ($topic['poster_role'] == 'lecturer') ? 'red-600' : 'blue-600'; ?>">
                            ...
                            <td class="py-3 px-6 text-center">
                                <a href="view_thread.php?thread_id=<?php echo $topic['id']; ?>"
                                    class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-1 px-3 rounded text-xs transition duration-200">
                                    View Thread
                                </a>
                            </td>
                        </tr>
